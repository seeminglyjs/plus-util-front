...
export default function TimeCalculate() {
    ...
    const timeCalculateRequestSend = async () => {
        let data = null
        const path = `/util/time/calculate/day`
                            ...
                            <div className="pt-48 py-15">
                                <div className={DefaultClassNames.FormDefaultParentDiv}>
                                    ...
                                    <div className="sm:col-span-2 my-4">
                                        ...
                                        <p className={DefaultClassNames.FormRegexSpanWhite}>{startDateText}</p>
                                    </div>
                                    ...
                                    <div className="sm:col-span-2 my-4">
                                        ...
                                        <p className={DefaultClassNames.FormRegexSpanWhite}>{endDateText}</p>
                                    </div>
